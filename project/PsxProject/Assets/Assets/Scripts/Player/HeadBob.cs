...
public class HeadBob : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        camPos = currentCamera.transform.localPosition;
        
    }

    void Update()
    {
        if (Input.GetAxisRaw(currentControllerManager.walkX) != 0 || Input.GetAxisRaw(currentControllerManager.walkY) != 0) //moving
        {
